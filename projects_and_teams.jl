...
Implement Snake game on new fancy hardware.
		...
		Solution(
			...
			"https://github.com/IgorStefanovic/fpga-matrix-snake/blob/master/RGB_LED_Snake.bit",
			"https://github.com/IgorStefanovic/fpga-matrix-snake/blob/master/Dokumentacija.odt"
		)
	),
	Project(
